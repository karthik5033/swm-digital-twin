    ...
    <div className="min-h-screen bg-[#070b14] text-white p-6 pb-24 md:p-12 font-sans selection:bg-teal-500/30 overflow-hidden relative">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="flex justify-center mb-10">
          <div className="bg-white/5 backdrop-blur-md p-1.5 rounded-full border border-white/10 flex flex-wrap gap-1 justify-center">
            <button
            ...
            <button
              ...
              className={`px-6 py-2.5 rounded-full text-sm font-semibold transition-all duration-300 ${activeTab === 'composition' ? 'bg-gradient-to-r from-green-500 to-teal-500 shadow-lg shadow-green-500/25 text-white' : 'text-gray-400 hover:text-white'}`}
            >
              Composition Analysis
            </button>
            <button
              onClick={() => setActiveTab('flow')}
              className={`px-6 py-2.5 rounded-full text-sm font-semibold transition-all duration-300 ${activeTab === 'flow' ? 'bg-gradient-to-r from-orange-500 to-amber-500 shadow-lg shadow-orange-500/25 text-white' : 'text-gray-400 hover:text-white'}`}
            >
              Waste Flow
            </button>
            <button
              onClick={() => setActiveTab('methane')}
              className={`px-6 py-2.5 rounded-full text-sm font-semibold transition-all duration-300 ${activeTab === 'methane' ? 'bg-gradient-to-r from-emerald-500 to-green-600 shadow-lg shadow-emerald-500/25 text-white' : 'text-gray-400 hover:text-white'}`}
            >
              Methane & Climate
            </button>
          </div>
            ...
            >
              ...
              <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-8 rounded-3xl">
                <div className="flex justify-between items-start flex-wrap gap-4 mb-6">
                  <div>
                    ...
                    <p className="text-gray-400 text-sm font-light">Source: BBMP Official Reports 1999–2013</p>
                  </div>
                ...
                <div className="h-72">
                  <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={BBMP_COMPOSITION_HISTORY} margin={{ top: 10, right: 30, left: 0, bottom: 5 }}>
                      ...
                      <XAxis dataKey="year" stroke="#64748b" tick={{ fill: '#94a3b8', fontSize: 13 }} />
                      <YAxis stroke="#64748b" tick={{ fill: '#94a3b8' }} unit="%" domain={[0, 75]} />
                      <RechartsTooltip
                        contentStyle={{ backgroundColor: 'rgba(15,23,42,0.95)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '12px' }}
                        itemStyle={{ color: '#fff' }}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-8 rounded-3xl flex flex-col">
                  ...
                  <p className="text-gray-400 text-sm mb-6">Based on BBMP 2013 data + CPCB projection</p>
                  <div className="relative h-56">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                      <div className="text-center">
                        <div className="text-2xl font-black text-white">23.1</div>
                  ...
                  <div className="grid grid-cols-2 gap-2 mt-4">
                    {HSR_COMPOSITION_2026.map(item => (
                      <div key={item.name} className="flex items-center gap-2">
                        ...
                        <span className="text-xs text-gray-300">{item.name.split(' ').slice(1).join(' ')} — {item.pct}%</span>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div className="bg-slate-900/80 border border-slate-700 rounded-3xl p-6 flex flex-col">
                  ...
                  <p className="text-gray-400 text-sm mb-5">Capacity check: HSR Layout waste routing</p>
                          ...
                          <tr key={item.name} className="hover:bg-slate-800/40">
                            <td className="py-3 px-2">
                              <div className="flex items-center gap-2">
                                ...
                                <span className="font-medium text-white">{item.name.split(' ').slice(1).join(' ')} {item.pct}%</span>
                              </div>
                            </td>
                            <td className="py-3 px-2 font-mono font-bold" style={{ color: item.color }}>{item.tons}T</td>
                            <td className="py-3 px-2 text-gray-300 text-xs">{item.dest}</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
                  ...
                  <div className="mt-5 space-y-3">
                    ...
                    <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-3 text-xs">
                      ...
                      <div className="flex justify-between items-center">
                        <span className="text-gray-400">HSR dry demand:</span>
          ...
          {activeTab === 'flow' && (
            ...
            >
              ...
              <div className="text-center">
                ...
                <p className="text-gray-400 text-base">From generation to processing — the complete waste journey</p>
              </div>
              ...
              <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8">
                ...
                <div className="flex justify-center mb-4">
                  <div className="bg-[#1f2937] border-2 border-teal-500 rounded-2xl px-8 py-4 text-center min-w-[220px]">
                    <div className="text-teal-400 font-bold text-xs uppercase tracking-widest mb-2">Generation</div>
                    <div className="text-white font-bold">46,219 residents</div>
                    <div className="text-gray-400 text-sm">× 0.5 kg/day (CPCB)</div>
                  ...
                  {[
                    ...
                    <div key={w.label} className="flex flex-col items-center gap-2">
                      <div className={`${w.bg} border-2 ${w.border} rounded-2xl p-4 text-center w-full`}>
                        ...
                        <div className="text-white font-bold text-lg">{w.pct}</div>
                      ...
                      <div className={`${w.bg} border ${w.border} rounded-xl px-3 py-2 text-center w-full text-xs`}>
                        ...
                        <div className="text-gray-400">{w.destSub}</div>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <tbody className="divide-y divide-slate-800">
                      {[
                        ...
                        <tr key={i} className="hover:bg-slate-800/40">
                          <td className="py-3 text-white font-medium">{r.type}</td>
                          <td className="py-3 text-amber-400 font-mono font-bold text-xs">{r.freq}</td>
                          <td className="py-3 text-gray-400 text-xs">{r.vehicle}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
                ...
                <div className="bg-slate-900/80 border border-slate-700 rounded-3xl p-6">
                  ...
                  <div className="space-y-3 text-sm mb-5">
                    <div className="flex justify-between"><span className="text-gray-400">16 DWCCs × 2.5 TPD avg:</span><span className="text-white font-bold">40 TPD total</span></div>
                    <div className="flex justify-between"><span className="text-gray-400">Dry waste demand:</span><span className="text-blue-400 font-bold">6.9 TPD</span></div>
                    <div className="flex justify-between"><span className="text-gray-400">Utilisation:</span><span className="text-amber-400 font-bold">17.5%</span></div>
                    <div className="flex justify-between"><span className="text-gray-400">Surplus capacity:</span><span className="text-green-400 font-bold">33.1 TPD</span></div>
                  </div>
                  <div className="text-xs text-gray-400 mb-2">16 DWCCs — 40 TPD capacity</div>
                ...
                <div className="bg-gradient-to-br from-green-900/30 to-teal-900/30 border border-green-500/30 rounded-3xl p-6">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      <div className="text-white font-bold text-lg">Diverted from landfill</div>
                      <div className="text-gray-400 text-sm">Wet → Bio-meth · Dry → DWCC</div>
                ...
                <div className="bg-slate-900/80 border border-slate-700 rounded-3xl p-6">
                  ...
                  <table className="w-full text-sm mb-4">
                    <thead>
                      <tr className="border-b border-slate-700">
                        <th className="text-left py-2 text-gray-400 font-bold text-xs uppercase">Metric</th>
                    ...
                    <tbody className="divide-y divide-slate-800">
                      {[
                        ...
                        <tr key={i} className="hover:bg-slate-800/40">
                          <td className="py-2.5 text-gray-300">{r.metric}</td>
          ...
          {activeTab === 'methane' && (
            ...
            >
              ...
              <div className="text-center">
                ...
                <p className="text-gray-400 text-base">IPCC 2006 + BBMP official data</p>
              </div>
              ...
              <div className="bg-gradient-to-r from-green-900/40 to-emerald-900/30 border-2 border-green-500/50 rounded-3xl p-6 flex flex-col md:flex-row items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-gray-300 text-sm mt-1">HSR Layout has <strong className="text-white">0 open dumpyards</strong>. All methane is captured by bio-methanisation units and converted to clean energy.</div>
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                {[
                  ...
                  <div key={i} className={`bg-gradient-to-b ${card.bg} to-transparent border ${card.border} rounded-3xl p-6`}>
                    ...
                    <div className="text-white font-bold text-sm mb-3">{card.label}</div>
                    <div className="text-gray-400 text-xs leading-relaxed">{card.sub}</div>
              ...
              <div className="bg-white/5 border border-white/10 rounded-3xl p-8">
                ...
                <div className="flex flex-col items-center gap-2">
                  ...
                  {/* Bio-meth */}
                  <div className="bg-[#1f2937] border-2 border-teal-500 rounded-2xl px-8 py-3 text-center min-w-[200px]">
                    <div className="text-teal-400 font-bold text-xs uppercase tracking-wider">Bio-methanisation</div>
                    <div className="text-white font-bold">2 units in HSR Layout</div>
                  </div>
                  <div className="w-0.5 h-6 bg-teal-500/50" /><div className="text-teal-400 text-xs">▼</div>
                  {/* Split */}
                  <div className="grid grid-cols-2 gap-8 w-full max-w-md">
                    <div className="flex flex-col items-center gap-2">
                      <div className="bg-[#1e3a5f] border-2 border-blue-500 rounded-2xl p-4 text-center w-full">
                        <div className="text-blue-400 font-bold text-xs">CH₄ Gas</div>
                        <div className="text-white font-black text-lg">3,548 m³</div>
                      ...
                      <div className="bg-[#1e3a5f] border border-blue-500/50 rounded-xl p-3 text-center w-full">
                        <div className="text-amber-400 font-black text-base">21,285 kWh</div>
                        <div className="text-gray-400 text-xs">energy/day</div>
                        <div className="text-green-400 text-xs mt-1">→ ~7,095 homes</div>
                      </div>
                    </div>
                    <div className="flex flex-col items-center">
                      <div className="bg-[#14532d] border-2 border-green-500/60 rounded-2xl p-4 text-center w-full">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                <div className="bg-white/5 border-2 border-teal-500/40 rounded-3xl p-6">
                  <div className="text-teal-400 font-black text-lg mb-2">Swachagraha Kalika Kendra</div>
                  <div className="text-gray-400 text-xs mb-3">📍 Sector 4, HSR Layout BBMP Park</div>
                  <p className="text-gray-300 text-sm leading-relaxed">&ldquo;One-of-a-kind Composting Learning Centre with live models of community and home composting units.&rdquo;</p>
                  <div className="text-xs text-gray-500 mt-3 italic">Source: Wikipedia + OpenCity</div>
                </div>
                <div className="bg-white/5 border-2 border-amber-500/40 rounded-3xl p-6">
                ...
                <div className="bg-white/5 border-2 border-blue-500/40 rounded-3xl p-6">
                  <div className="text-blue-400 font-black text-lg mb-2">Kudlu Biogas Plant</div>
                  <div className="text-gray-400 text-xs mb-2">📍 Kudlu (adjacent to HSR Layout)</div>
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed">Large biogas plant being built near HSR Layout &mdash; will handle overflow wet waste from HSR. Significant capacity expansion incoming.</p>
              ...
              <div className="bg-white/5 border border-white/10 rounded-3xl p-8">
                ...
                <div className="grid grid-cols-2 gap-0 border border-white/10 rounded-2xl overflow-hidden text-sm">
                  <div className="bg-green-900/20 p-4 border-r border-white/10">
                    ...
                    {['0 open dumpyards','All CH₄ captured','Energy generated','Carbon credits earned','Zero smell / disease'].map((t,i) => (
                      <div key={i} className="flex items-center gap-2 py-1.5 text-gray-300 border-b border-white/5 last:border-0">
