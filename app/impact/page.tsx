...
export default function ImpactDashboard() {
  ...
  const lulcData = [
    { name: 'Built-up', value: HSR_DATA.lulc_builtup, color: '#e74c3c' },
    { name: 'Vegetation', value: HSR_DATA.lulc_vegetation, color: '#27ae60' },
    { name: 'Open Land', value: HSR_DATA.lulc_open, color: '#f39c12' },
    { name: 'Water', value: HSR_DATA.lulc_water, color: '#3498db' }
  ];
