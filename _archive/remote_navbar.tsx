...
const LINKS = [
  ...
  { href: '/vehicle-sim', label: '≡ƒÜ¢ Vehicle Sim' },
];
      ...
      <div className="flex items-center gap-2 md:gap-6">
        ...
        >
          <motion.div initial={false} animate={{ rotate: isDark ? 180 : 0 }} transition={{ duration: 0.5, ease: "backOut" }}>
            {isDark ? <span className="text-xl">ΓÿÇ∩╕Å</span> : <span className="text-xl">≡ƒîÖ</span>}
          </motion.div>
        </button>
                ...
                <table className="w-full text-left text-sm whitespace-nowrap">
                  ...
                  <tbody className="divide-y divide-slate-100 dark:divide-slate-800 font-medium text-slate-700 dark:text-slate-400">
                    {[
                      ...
                      { point: 'Population', val: '46,219', src: 'Buildings├ùCensus 2011 Karnataka' },
                      { point: 'Per capita', val: '0.5 kg/day', src: 'CPCB large city official' },
                      { point: 'Daily waste', val: '23.1 Tons', src: '46,219 ├ù 0.5kg' },
                      ...
                      { point: 'Collection schedule', val: 'Daily/2├ùwk', src: 'hsrcitizenforum.in' },
                      { point: 'Wet routing', val: 'ΓåÆ Bio-meth', src: 'ceeindia.org/hsr-swm' },
                      ...
                      { point: 'IPCC CHΓéä factor', val: '0.25 m┬│/kg', src: 'IPCC 2006' },
                      { point: 'CHΓéä GWP', val: '28├ù COΓéé', src: 'IPCC AR5' },
                      { point: 'Energy conv.', val: '6 kWh/m┬│', src: 'Standard' },
                      { point: 'Carbon price', val: 'Γé╣2,000/ton', src: 'India market 2024' },
              ...
              <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800/50 rounded-2xl p-5 flex flex-col gap-4 text-sm text-amber-800 dark:text-amber-400 font-medium leading-relaxed">
                <div>
                  ...
                  <div className="opacity-90 leading-normal flex flex-col gap-1.5 ml-1">
                    <div><span className="font-bold text-amber-900 dark:text-amber-300">≡ƒôä bbc.csv</span> ΓÇö BBMP official waste composition data</div>
                    <div><span className="font-bold text-amber-900 dark:text-amber-300">≡ƒôä xxm.pdf</span> ΓÇö CPCB Annual Report 2021-2022 on Solid Waste</div>
                    <div><span className="font-bold text-amber-900 dark:text-amber-300">Geospatial</span> ΓÇö OpenStreetMap, Census 2011, geoiq.io, HSR_Layout_SD.tif</div>
                  </div>
                </div>
                ...
                <div className="bg-amber-100/60 dark:bg-amber-950/40 rounded-xl p-3 text-xs leading-relaxed">
                  ...
                  <div className="text-amber-700 dark:text-amber-500 mt-1 italic">Trend: organic increasing yearly ΓÇö validates bio-meth demand</div>
