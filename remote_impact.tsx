    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 font-sans pb-24 transition-colors relative">
      ...
      {showWarningBanner && (
        <div className="w-full bg-red-600 text-white font-medium text-center py-3 px-4 flex items-center justify-center gap-2 shadow-md sticky top-0 z-50">
          <span>ΓÜá∩╕Å HSR Main Zone at critical segregation ΓÇö only 25% waste being segregated</span>
        </div>
      )}
      ...
      <main className="max-w-7xl mx-auto px-6 pt-16 mt-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-3xl p-5 shadow-sm">
            <h4 className="font-extrabold text-red-800 dark:text-red-300 mb-2 flex items-center gap-2">≡ƒÅÑ Hospital Alert</h4>
          ...
          <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-3xl p-5 shadow-sm">
            <h4 className="font-extrabold text-amber-800 dark:text-amber-300 mb-2 flex items-center gap-2">≡ƒôÜ Schools Alert</h4>
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-3xl p-5 shadow-sm">
            <h4 className="font-extrabold text-blue-800 dark:text-blue-300 mb-2 flex items-center gap-2">≡ƒÅ¬ Commercial Alert</h4>
          ...
          <div className="bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 rounded-3xl p-5 shadow-sm">
            <h4 className="font-extrabold text-emerald-800 dark:text-emerald-300 mb-2 flex items-center gap-2">≡ƒÆ╗ IT Office Alert</h4>
          ...
          <div className="flex flex-col gap-6">
            <div className="bg-gradient-to-br from-indigo-50 to-rose-50 dark:from-indigo-950/30 dark:to-rose-950/30 border border-indigo-100 dark:border-indigo-900/50 rounded-3xl p-6 shadow-sm flex-1">
              ...
              <ul className="space-y-3 text-slate-700 dark:text-slate-300 font-medium text-sm">
                <li className="flex gap-2"><span>≡ƒôê</span> HSR Layout population grew <b>389%</b> since 2001.</li>
                <li className="flex gap-2"><span>≡ƒùæ∩╕Å</span> Waste generation grew <b>530%</b> in the same period.</li>
                <li className="flex gap-2 bg-white/50 dark:bg-slate-900/50 p-2 rounded-lg text-rose-600 dark:text-rose-400 font-bold border border-rose-100 dark:border-rose-900">ΓÜá∩╕Å Waste grows FASTER than population.</li>
              </ul>
            </div>
        ...
        <section className="mb-20">
          <h2 className="text-3xl font-extrabold text-slate-800 dark:text-white mb-6">Two-Tier Collection System ΓÇö HSR Layout</h2>
          ...
          <div className="w-full bg-slate-900 border border-slate-700 rounded-3xl p-8 shadow-sm mb-8 flex flex-col md:flex-row items-center justify-between text-center gap-4">
             <div className="flex flex-col items-center">
               <div className="w-16 h-16 bg-slate-800 rounded-full flex items-center justify-center text-2xl border border-slate-600 mb-2">≡ƒÅá</div>
               <span className="text-white font-bold text-sm">Houses</span>
             </div>
             <span className="text-teal-400 font-extrabold text-xl">ΓåÆ</span>
             <div className="flex flex-col items-center">
               <div className="w-16 h-16 bg-orange-500/20 text-orange-400 rounded-full flex items-center justify-center text-2xl border border-orange-500/50 mb-2">≡ƒ¢║</div>
               <span className="text-white font-bold text-sm">Auto (Sub Roads)</span>
             </div>
             <span className="text-teal-400 font-extrabold text-xl">ΓåÆ</span>
             <div className="flex flex-col items-center">
               <div className="w-16 h-16 bg-blue-500/20 text-blue-400 rounded-full flex items-center justify-center text-2xl border border-blue-500/50 mb-2">≡ƒÜ¢</div>
               <span className="text-white font-bold text-sm">Truck Hub (Main Rd)</span>
             </div>
             <span className="text-teal-400 font-extrabold text-xl">ΓåÆ</span>
             <div className="flex flex-col items-center">
               <div className="w-16 h-16 bg-emerald-500/20 text-emerald-400 rounded-full flex items-center justify-center text-2xl border border-emerald-500/50 mb-2">≡ƒÅ¡</div>
          ...
          <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-3xl p-6 shadow-sm overflow-x-auto">
            ...
            <table className="w-full text-left text-sm text-slate-600 dark:text-slate-300">
              ...
              <tbody className="divide-y divide-slate-100 dark:divide-slate-700 font-medium">
                ...
                <tr className="hover:bg-slate-50 dark:hover:bg-slate-800/50">
                   <td className="px-4 py-3 text-slate-800 dark:text-white font-bold">Fuel cost/day</td><td className="px-4 py-3 opacity-60">Γé╣4,200</td><td className="px-4 py-3 text-emerald-500 font-bold bg-emerald-50/50 dark:bg-emerald-900/10">Γé╣2,100</td>
                </tr>
                <tr className="hover:bg-slate-50 dark:hover:bg-slate-800/50">
        ...
        <section className="mb-20">
          <h2 className="text-3xl font-extrabold text-slate-800 dark:text-white mb-6">Land Use Analysis ΓÇö Sentinel-2 Classification</h2>
