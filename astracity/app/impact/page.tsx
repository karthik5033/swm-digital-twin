      ...
      <main className="max-w-7xl mx-auto px-6 pt-16">
        ...
        <section className="text-center mb-20">
          ...
          >
            ...
            <p className="text-slate-500 font-medium">
              Across 198 wards · {economicParams.totalTrucks.toLocaleString()} trucks · 24 transfer stations
            </p>
          </motion.div>
        </section>
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
          {[
            ...
            { title: "Carbon Credits", icon: <LeafIcon />, value: carbonCr, desc: `${economicParams.methaneReductionTons.toLocaleString()} tons CO₂e reduced · ₹${economicParams.carbonPricePerTon}/ton` },
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="font-bold text-slate-600">{card.title}</h3>
              </div>
              <div className="text-4xl font-extrabold text-slate-800 tracking-tight mb-2">
                ₹{card.value.toFixed(1)}<span className="text-lg text-slate-500 font-bold">Cr</span>
              </div>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-20">
          ...
          >
            <div className="mb-6">
              <h2 className="text-2xl font-extrabold text-slate-800">Operational Inefficiencies</h2>
              <p className="text-sm font-medium text-slate-500">Resource expenditure before vs after AstraCity (Crores)</p>
            </div>
          ...
          >
            <div className="mb-6">
              <h2 className="text-2xl font-extrabold text-slate-800">ROI Timeline</h2>
              <p className="text-sm font-medium text-slate-500">Cumulative Savings (in Lakhs) projected over 24 months</p>
            </div>
            <div className="h-80 w-full">
              {mounted && (
                <ResponsiveContainer width="100%" height="100%">
        ...
        <section className="flex flex-col items-center justify-center">
          ...
          >
            ...
            <button className="bg-white hover:bg-slate-50 border-2 border-slate-200 text-slate-600 font-bold text-lg px-8 py-4 rounded-2xl shadow-sm transition-all hover:text-slate-800">
              Download Raw Data
            </button>
          </motion.div>
        </section>
